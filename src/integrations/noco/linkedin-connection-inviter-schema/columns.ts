...
export const CONNECTION_RUN_COLUMNS = [
  ...
  { title: 'retry_state_json', column_name: 'retry_state_json', uidt: 'LongText' },
  { title: 'search_progress_json', column_name: 'search_progress_json', uidt: 'LongText' },
  { title: 'skip_reason_counters_json', column_name: 'skip_reason_counters_json', uidt: 'LongText' },
  { title: 'next_action_at', column_name: 'next_action_at', uidt: 'DateTime' },
  { title: 'paused_at', column_name: 'paused_at', uidt: 'DateTime' },
  { title: 'executor_id', column_name: 'executor_id', uidt: 'SingleLineText' },
  { title: 'heartbeat_at', column_name: 'heartbeat_at', uidt: 'DateTime' },
