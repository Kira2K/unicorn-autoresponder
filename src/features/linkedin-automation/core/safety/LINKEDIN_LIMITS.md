...
Недельная норма Connection Inviter зависит от текущего числа связей:
...
Она делится на Пн–Пт без догоняющих отправок. Недельная цель — 70% recruiters
и 30% technical; нехватка одной категории не замещается другой.
