...
- Приглашения отправляются последовательно. Между двумя отправками диспетчер
  каждый раз выбирает новую случайную задержку от 15 секунд до 3 минут.
- При остановке аккаунта, достижении лимита или ошибке ожидание прерывается.
