...
function searchProgressFromRow(value: unknown): ConnectionSearchProgress {
  const fallback: ConnectionSearchProgress = { keyIndex: { recruiter: 0, technical: 0 },
    ...
    exhausted: { recruiter: false, technical: false }, pass: 1, passUsedSearchKeys: [],
    pendingCandidates: [] }
  ...
  return { ...fallback, ...progress,
    ...
    passUsedSearchKeys: Array.isArray(progress.passUsedSearchKeys)
      ? progress.passUsedSearchKeys : [],
  ...
  return {
    ...
    counters: (() => {
      ...
      return { ...counters, sentByAudience: counters.sentByAudience ?? { recruiter: 0, technical: 0 },
        shortfallByAudience: counters.shortfallByAudience ?? { recruiter: 0, technical: 0 },
        filterFunnel: {
