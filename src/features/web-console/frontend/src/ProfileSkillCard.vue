...
const props = defineProps({ steps: { type: Array, default: () => [] }, showList: { type: Boolean, default: true } })
...
<template>
  <div data-testid="profile-skills-summary">
    ...
    <details v-if="showList && skills.added.length"><summary>Новые навыки · {{ skills.added.length }}</summary>
