export type Market = import('../../../platform/db/types.ts').Market
export type DbClientAutomationData =
  import('../../../platform/db/types.ts').ClientAutomationData
...
export type AutomationTargetOptions =
  import('../../../platform/db/types.ts').AutomationTargetOptions
