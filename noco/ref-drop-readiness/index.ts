...
const REF_CANDIDATES: RefCandidate[] = [
  ...
  ref('dolphinMainRaw', 'dolphin_main_ref', 'own_row_ref', 'drop_later_candidate', 'Own-row raw tracking identifier used in raw Dolphin reports.'),
  {
...
const EXPECTED_RELATIONS: ExpectedRelation[] = [
  ...
  relation('dolphinMainRaw.client', 'dolphinMainRaw', 'rel_dolphinMainRaw_client', 'clients', 'Native Dolphin main raw row to client relation.'),
  relation('dolphinMainRaw.profile_ru', 'dolphinMainRaw', 'rel_dolphinMainRaw_dolphin_profile_ru', 'dolphinProfiles', 'Native Dolphin main raw row to RU Dolphin profile relation.'),
  relation('dolphinMainRaw.profile_en', 'dolphinMainRaw', 'rel_dolphinMainRaw_dolphin_profile_en', 'dolphinProfiles', 'Native Dolphin main raw row to EN Dolphin profile relation.'),
